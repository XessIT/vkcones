...
class _PrintingViewState extends State<PrintingView> {
  ...
  Future<void> filterFromtodateData(
    ...
    try {
      final url = Uri.parse(
          'http://localhost:3309/get_fromtodate21?fromDate=$fromDate&toDate=$toDate&shiftType=$shiftType');
  ...
  Future<List<Map<String, dynamic>>> fetchduplicate() async {
    try {
      ...
      final response = await http.get(Uri.parse('http://localhost:3309/fetch_printing'));
      if (response.statusCode == 200) {
  ...
  Future<void> insertDataSup(Map<String, dynamic> dataToInsertSup) async {
    const String apiUrl = 'http://localhost:3309/Printing_update'; // Replace with your server details
    try {
                                          ...
                                          Padding(
                                            ...
                                            child: const Row(
                                              children: [
                                                ...
                                                Text("Printing Edit", style: TextStyle(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Align(
                                              alignment:Alignment.topLeft,
                                              child:Text("Printing Details ",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),
                                              ),
                                            ),
                                            Align(
                                              alignment: Alignment.topRight,
                                                  ...
                                                  child: TypeAheadFormField<String>(
                                                    ...
                                                    suggestionsCallback: (pattern) async {
                                                      ...
                                                      (item['alterEmp']?.toString()?.toLowerCase() ?? '')
                                                          ...
                                                          item['alterEmpID']?.toString()?.toLowerCase() != null  &&// Filter out null alterEmpID
