...
class WindingView2 extends StatefulWidget {
  ...
  @override
  State<WindingView2> createState() => _WindingView2State();
}

class _WindingView2State extends State<WindingView2> {
  ...
  Future<void> filterFromtodateData(
    ...
    try {
      final url = Uri.parse(
          'http://localhost:3309/get_fromtodate20?fromDate=$fromDate&toDate=$toDate&shiftType=$shiftType');
...
//  DateTime toDate = DateTime.now();
  ...
  Future<List<Map<String, dynamic>>> fetchduplicate() async {
    try {
      ...
      final response = await http.get(Uri.parse('http://localhost:3309/fetch_winding'));
      if (response.statusCode == 200) {
  ...
  Future<void> insertDataSup(Map<String, dynamic> dataToInsertSup) async {
    const String apiUrl = 'http://localhost:3309/winding_update'; // Replace with your server details
    try {
                                          ...
                                          Padding(
                                            ...
                                            child: const Row(
                                              children: [
                                                ...
                                                Text("Winding Edit", style: TextStyle(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Align(
                                              alignment:Alignment.topLeft,
                                              child:Text("Winding Details ",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),
                                              ),
                                            ),
                                            Align(
                                              alignment: Alignment.topRight,
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: DropdownButtonHideUnderline(
                                                      child: DropdownButton<String>(
                                                        ...
                                                        value: dropdownvalue,
                                                        // value: widget.shiftType.toString(),
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                if (dropdownvalue == "Shift Type") {
                                  ...
                                  setState(() {
                                    errorMessage = '* Enter a correct employee name 3';
                                  });
                                }
