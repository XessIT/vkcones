...
class DcReport extends StatefulWidget {
  const DcReport({Key? key}) : super(key: key);
  @override
  State<DcReport> createState() => _DcReportState();
}
class _DcReportState extends State<DcReport> {
  ...
  Future<void> fetchData() async {
    try {
      final url = Uri.parse('http://localhost:3309/getDC/');
                      ...
                      children: [
                        Padding(
                          ...
                          child: MaterialButton(
                            ...
                            onPressed: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>DcReportPDFView(
              ...
              children: [
                IconButton(icon: Icon(Icons.remove_red_eye_outlined,color:Colors. blue,),onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>dcViwe(
                    ...
                    pincode:row["pincode"],
                    supplyPlace:row["supplyPlace"],
                    transportNo:row["transNo"],
                    invNo:row["invoiceNo"],
                ...
                IconButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>dcIndividualReportPDFView(
                        dcNo: row["dcNo"],
                        date:row["date"],
                        custName:row["custName"],
                        custCode:row["custCode"],
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      for (var item in itemGroups) {
        String invoiceNo = item['custName'];
