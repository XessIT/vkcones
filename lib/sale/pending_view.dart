...
class PendingView extends StatefulWidget {
  ...
  const PendingView({
    ...
    required this.date,
    required this.itemGroup, required this.custpincode, required this.pendingOrderNo
  }) : super(key: key);
...
*//*
  ...
  double grandTotal = 0.0; // Initialize the grandTotal variable
                              ...
                              children: [
                                Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(left: 600,right:15),
                                        child: Column(
                                                  ...
                                                  Column(
                                                    children: [
                                                      Row(
                                                        children: [
                                                          const Padding(
                                                            padding: EdgeInsets.only(left:840),
