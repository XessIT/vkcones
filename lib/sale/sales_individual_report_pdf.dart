              ...
              children: [
                ...
                pw.Padding(
                  ...
                  child: pw.Center( child: pw.Column(
                      children: [
                        pw.SizedBox(height: 3),
                        pw.Text(data[i]['amt'],style: pw.TextStyle(fontSize: 9,font:font1)),
                        pw.SizedBox(height: 3),
                      ])),
                ),
                pw.Padding(
                  ...
                  child: pw.Center( child: pw.Column(
                      children: [
                        pw.SizedBox(height: 3),
                        pw.Text(data[i]['total'],style: pw.TextStyle(fontSize: 9,font:font1)),
                        pw.SizedBox(height: 3),
                      ])),
                ),
              ],
                                                  ...
                                                  pw.Padding(
                                                    ...
                                                    child: pw.Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        pw.SizedBox(height: 3),
                                                        pw.Text(widget.custpincode.toString(), style: pw.TextStyle(fontSize: 9,font:font1)),
                                                        pw.SizedBox(height: 3),
                                                        pw.Text(widget.custmobile.toString(), style: pw.TextStyle(fontSize: 9,font:font1)),
                                                        pw.SizedBox(height: 3),
                                                        pw.Text(widget.transportNo.toString(), style: pw.TextStyle(fontSize: 9,font:font1)),
                                                      ],
                                                    ),
                                                  ),
                                                ],
