...
class NonOrderSalesView extends StatefulWidget {
  ...
  const NonOrderSalesView({required this.customerData ,Key? key,
  ...
  @override
  State<NonOrderSalesView> createState() => _NonOrderSalesViewState();
}

class _NonOrderSalesViewState extends State<NonOrderSalesView> {
  ...
  Future<List<Map<String, dynamic>>> fetchUnitEntries(String invoiceNo) async {
    try {
      final url = Uri.parse('http://localhost:3309/nonsales_item_view?invoiceNo=$invoiceNo');
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          const Padding(
                                            ...
                                            child: Text("Non Order Sales Report",style: TextStyle(fontSize:20,fontWeight: FontWeight.bold),),
                                          ),
                                        ],
                                      ),
