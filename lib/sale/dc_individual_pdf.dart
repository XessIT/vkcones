...
class dcIndividualReportPDFView extends StatefulWidget {
  String? dcNo;
  String? invNo;
  String? custCode;
  int custMobile;
  ...
  @override
  State<dcIndividualReportPDFView> createState() =>
      _dcIndividualReportPDFViewState();
}
                                  ...
                                  pw.Column(
                                      children: [
                                        pw.Align(
                                          ...
                                          child: pw.Padding(
                                            padding: pw.EdgeInsets.only(left:70,top:10),
                                            child: pw.Column(
                                              crossAxisAlignment:
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Container(
                                      ...
                                      child: pw.Text(total.toStringAsFixed(2),textAlign:pw.TextAlign.center,
