          ...
          pw.TableRow(
            children: [
              ...
              pw.Padding(
                ...
                pw.Column(children: [
                  pw.SizedBox(height: 3),
                  pw.Text('Rate/Cone',style: pw.TextStyle(fontSize: 6),),
                  pw.SizedBox(height: 3),
                ])),),
              ...
              children: [
                ...
                pw.Center(
                    child: pw.Column(
                        children: [
                          pw.SizedBox(height: 3),
                          pw.Text(data1[i]['itemGroup'],style: pw.TextStyle(fontSize: 6),),
                          pw.SizedBox(height: 3),
                        ])),
                pw.Center(child: pw.Column(
                    children: [
                      pw.SizedBox(height: 3),
                      pw.Text(data1[i]['itemName'],style: pw.TextStyle(fontSize: 6)),
                      pw.SizedBox(height: 3),
                    ])),
                pw.Padding(
                  padding: pw.EdgeInsets.only(right: 0),
                ...
                pw.Padding(
                  ...
                  child: pw.Center( child: pw.Column(
                      children: [
                        pw.SizedBox(height: 3),
                        pw.Text(data1[i]['rate'],style: pw.TextStyle(fontSize: 6)),
                        pw.SizedBox(height: 3),
                      ])),
                ),
                pw.Padding(
                  ...
                  child: pw.Center( child: pw.Column(
                      children: [
                        pw.SizedBox(height: 3),
                        pw.Text(data1[i]['amt'],style: pw.TextStyle(fontSize: 6)),
                        pw.SizedBox(height: 3),
                      ])),
                ),
                pw.Padding(
                  ...
                  child: pw.Center( child: pw.Column(
                      children: [
                        ...
                        pw.SizedBox(height: 3),
                        pw.Text(data1[i]['total'],style: pw.TextStyle(fontSize: 6)),
                        pw.SizedBox(height: 3),
                      ])),
                ),
              ],
            ...
            children: [
              ...
              pw.Padding(
                ...
                child: pw.Center( child: pw.Column(
                    children: [
                      pw.SizedBox(height: 3),
                      pw.Text(data[i]['amt'].toString(),style: pw.TextStyle(fontSize: 6)),
                      pw.SizedBox(height: 3),
                    ])),
              ),
              pw.Padding(
                ...
                child: pw.Center( child: pw.Column(
                    children: [
                      pw.SizedBox(height: 3),
                      pw.Text(data[i]['amtGST'].toString(),style: pw.TextStyle(fontSize: 6)),
                      pw.SizedBox(height: 3),
                    ])),
              ),  pw.Padding(
                padding: pw.EdgeInsets.only(right: 0),
                child: pw.Center( child: pw.Column(
                    children: [
                      pw.SizedBox(height: 3),
                      pw.Text(data[i]['total'].toString(),style: pw.TextStyle(fontSize: 6)),
                      pw.SizedBox(height: 3),
                    ])),
              ),
            ],
                        ...
                        child: pw.Container(
                          child: pw.Column(
                            children: [
                                        ...
                                        pw.Padding(
                                          ...
                                          child: pw.Column(
                                            ...
                                            children: [
                                              ...
                                              pw.SizedBox(height: 3),
                                              pw.Text(datacustomer[0]["custAddress"], style: pw.TextStyle(fontSize: 7,)),
                                              pw.SizedBox(height: 3),
                                              pw.Text(datacustomer[0]["pincode"]??'', style: pw.TextStyle(fontSize: 7,)),
                                              pw.SizedBox(height: 3),
                                              pw.Text(datacustomer[0]["custMobile"].toString(), style: pw.TextStyle(fontSize: 7,)),
                                              pw.SizedBox(height: 3),
                                            ],
                                          ),
                                        ),
                                        ...
                                        pw.Padding(
                                          ...
                                          decoration: pw.BoxDecoration(
                                            ...
                                            pw.Row(
                                                mainAxisAlignment: pw.MainAxisAlignment.end,
                                                children: [
                                                  pw.Text(    "${widget.grandtotal.toString()}",style: pw.TextStyle(fontSize: 6)),
                                                ]
                                            ),),
                                        ),                                  ]
                                  ),),
                              ...
                              pw.Padding(
                                padding: pw.EdgeInsets.only(left: 340),child:
                              pw.Container(
                                  width: 90,
                                  padding: pw.EdgeInsets.all(2.0),
                                  decoration: pw.BoxDecoration(
                                  ...
                                  child: pw.Row(
                                      children: [
                                        pw.Column(
                                            crossAxisAlignment: pw.CrossAxisAlignment.start,
                                            children: [
                                              pw.Text("Sales Total",style: pw.TextStyle(fontSize: 6)),
