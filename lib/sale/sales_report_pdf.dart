...
class SaleReportPDF extends StatefulWidget {
  final List<Map<String, dynamic>> customerData;

  SaleReportPDF({super.key,
    required this.customerData
  });

  @override
  State<SaleReportPDF> createState() => _SaleReportPDFState();
}

class _SaleReportPDFState extends State<SaleReportPDF> {
