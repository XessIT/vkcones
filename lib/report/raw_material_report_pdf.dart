...
class RawMaterialReportPdf extends StatefulWidget {
  final List<Map<String, dynamic>> customerData;


  RawMaterialReportPdf({
  ...
  @override
  State<RawMaterialReportPdf> createState() => _RawMaterialReportPdfState();
}
int serialNumber=1;
class _RawMaterialReportPdfState extends State<RawMaterialReportPdf> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Raw Material Report PDF"), centerTitle: true,),
      body: PdfPreview(
