...
import '../home.dart';
import 'Other_Worker_Report_Pdf.dart';

class Other_Worker_Report extends StatefulWidget {
  const Other_Worker_Report({Key? key}) : super(key: key);
  @override
  State<Other_Worker_Report> createState() => _Other_Worker_ReportState();
}
class _Other_Worker_ReportState extends State<Other_Worker_Report> {
                        ...
                        Row(
                            ...
                            children: [
                              const Row(children: [
                                ...
                                Text("Other Worker Report", style: TextStyle(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Other_Worker_Report()));
                                },
                              ),
                              IconButton(
                    ...
                    children: [
                      Padding(
                        ...
                        child: MaterialButton(
                          ...
                          height: 40,
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>OtherWorkerReportPdf(
