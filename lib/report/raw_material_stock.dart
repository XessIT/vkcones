...
class RawMaterialStockEntries extends StatefulWidget {
  const RawMaterialStockEntries({Key? key}) : super(key: key);
  @override
  State<RawMaterialStockEntries> createState() => _RawMaterialStockEntriesState();
}
class _RawMaterialStockEntriesState extends State<RawMaterialStockEntries> {
                    ...
                    children: [
                      Padding(
                        ...
                        child: MaterialButton(
                          ...
                          height: 40,
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>RawMaterialReportPdf(customerData: filteredData,)));
