...
class BalanaceSheetPDF extends StatefulWidget {
  final String TotalgrandTotal;
  final String TotaldeductionAmnt;
  final String TotalreceivedAmnt;
  ...
  BalanaceSheetPDF({
    ...
    required this.TotaldeductionAmnt,
    required this.TotalreceivedAmnt,
  ...
  @override
  State<BalanaceSheetPDF> createState() => _BalanaceSheetPDFState();
}

class _BalanaceSheetPDFState extends State<BalanaceSheetPDF> {
  String? totalbalance;
                            ...
                            pw.Padding(
                              ...
                              child:pw.Row(
                                ...
                                children: [
                                  ...
                                  pw.Text("Grand Total", style: pw.TextStyle(fontSize: 6, color: PdfColors.black)),
