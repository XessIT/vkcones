...
class FinishingReportPdf extends StatefulWidget {
  ...
  @override
  State<FinishingReportPdf> createState() => _FinishingReportPdfState();
}
int serialNumber=1;
class _FinishingReportPdfState extends State<FinishingReportPdf> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Finishing Report"), centerTitle: true,),
      body:
      PdfPreview(
