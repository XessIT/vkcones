...
import 'package:vinayaga_project/sale/non_sales_individual_view.dart';
...
import '../home.dart';
class NonOrderSalesReport extends StatefulWidget {
  const NonOrderSalesReport({Key? key}) : super(key: key);
  @override
  State<NonOrderSalesReport> createState() => _NonOrderSalesReportState();
}
class _NonOrderSalesReportState extends State<NonOrderSalesReport> {
  ...
  Future<void> fetchData() async {
    try {
      final url = Uri.parse('http://localhost:3309/get_non_sales_order_entry/');
  ...
  Widget build(BuildContext context) {
    ...
    // if (data.isEmpty) {
    //   return Center(child: const CircularProgressIndicator()); // Show a loading indicator while data is fetched.
    // }
    return MyScaffold(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            PaginatedDataTable(
                              columnSpacing:100, rowsPerPage:25,
                              columns: [
              ...
              IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => NonOrderSalesView(
                        customerData:row["checkOrderNo"]=="" ?row["orderNo"]:row["checkOrderNo"],                        invoiceNo: row["invoiceNo"],
