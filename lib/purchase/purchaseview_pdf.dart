                    ...
                    child: pw.Container(
                      ...
                      child: pw.Container(
                        child: pw.Column(
                          children: [
                            pw.Padding(
                              padding: pw.EdgeInsets.only(left:24,bottom: 10,top: 10),
                              child: pw.Row(
                                children: [
                                  pw.Text(
                                    "Customer Details",
                                              ...
                                              pw.Padding(
                                                ...
                                                child: pw.Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    pw.SizedBox(height: 3),
                                                    if (widget.deliveryType != null && widget.deliveryType!.isNotEmpty) // Check if deliveryType is not null and not empty
                                                      pw.Text(
                                                        "Delivery Type",
                                                        style: pw.TextStyle(
                                                          fontSize: 9,
                                              ...
                                              pw.Padding(
                                                ...
                                                child: pw.Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    pw.SizedBox(height: 3),
                                                    if (widget.deliveryType != null && widget.deliveryType!.isNotEmpty)
                                                    pw.Text(
                                                      " :",
                                                      style: pw.TextStyle(
                                                        fontSize: 9,
