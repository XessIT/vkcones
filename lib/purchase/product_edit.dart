...
class productView extends StatefulWidget {
  ...
  productView({Key? key,
    ...
    required this.prodName, required this.unit,// required this.prodRate,
  }) : super(key: key);
                          ...
                          onPressed: () async {
                            if (prodNameController.text.isNotEmpty) {
                              bool isDuplicate = data.any((item) {
                                String existingName = item['prodName']?.toString() ?? '';
                                String sanitizedInput = prodNameController.text.replaceAll(RegExp(r'\s+'), '').toLowerCase();
                                String sanitizedExistingName = existingName.replaceAll(RegExp(r'\s+'), '').toLowerCase();
                                return sanitizedExistingName == sanitizedInput;
                              });
                              if (isDuplicate) {
                                setState(() {
                                  errorMessage =
