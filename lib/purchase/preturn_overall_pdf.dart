...
class PreturnOverallReport extends StatefulWidget {
  int sn = 0;
  ...
  @override
  State<PreturnOverallReport> createState() => _PreturnOverallReportState();
}
...
class _PreturnOverallReportState extends State<PreturnOverallReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Purchase Return PDF"), centerTitle: true,),
      body: PdfPreview(
