...
class NonPurchaseEntry extends StatefulWidget {
  const NonPurchaseEntry({Key? key}) : super(key: key);
  @override
  State<NonPurchaseEntry> createState() => _NonPurchaseEntryState();
}
class _NonPurchaseEntryState extends State<NonPurchaseEntry> {
            ...
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => NonPurchaseEntry()),
                  );
                },
                child: Text('OK'),
              ),
                                  ...
                                  children: [
                                    Row(
                                        ...
                                        children: [
                                          ...
                                          Text("Non Purchase Entry",style: TextStyle(fontSize:22,fontWeight: FontWeight.bold),),
                                        ]
                                    ),
                                    Container(
                                      width: 100,
                                                  ...
                                                  TableCell(
                                                    child: Padding(
                                                      ...
                                                      child:  j == 4
                                                        ...
                                                        // Assuming that 'Unit' is the third column
                                                        onChanged: (value) {
                                                        ...
                                                        onSuggestionSelected: (suggestion) async {
                                                          ...
                                                          // Fetch unit based on prodCode and prodName
                                                          final unit = await fetchUnitInPO(controllers[rowIndex][0].text, productName);
                                                          // Update the unit controller
                                                          controllers[rowIndex][2].text = unit;
                                                        },
                                                      ),
                                  ...
                                  return AlertDialog(
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=> NonPurchaseEntry()));
                                        },
                                      ),
                                      TextButton(
                                        child: const Text('No'),
