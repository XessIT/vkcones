            ...
            build: (pw.Context context) {
              ...
              return pw.Column(
                ...
                children: [
                                ...
                                children: [
                                  pw.TableRow(
                                    children: [
                                      ...
                                      pw.Container(
                                        padding: pw.EdgeInsets.all(8.0),
                                        child: pw.Center(child: pw.Text('Item Group',
                                            style: pw.TextStyle(fontSize: 6,
                                                fontWeight: pw.FontWeight.bold)),
                                        ),),
                                      pw.Container(
                                      ...
                                      pw.Container(
                                          padding: pw.EdgeInsets.all(8.0),
                                          child: pw.Center(
                                            child: pw.Text('Available Quantity',
                                                style: pw.TextStyle(fontSize: 6,
                                                    fontWeight: pw.FontWeight.bold)),)
                                      ),
                                  ...
                                  ...pageData.asMap().entries.map((entry) {
                                    ...
                                    return pw.TableRow(children: [
                                      ...
                                      pw.Container(
                                          padding: pw.EdgeInsets.all(8.0),
                                          child: pw.Center(
                                            child: pw.Text(data['itemGroup'].toString(),
                                                style: pw.TextStyle(fontSize: 6)),)
                                      ),
                                      pw.Container(
                                        padding: pw.EdgeInsets.all(8.0),
                  ...
                  pw.SizedBox(height: 5),
                  pw.Container(
                    //height: pageHeight-10 , // Adjust the factor as needed
                    child: pw.Align(
